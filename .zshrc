...
alias oldvim="vim"
alias shellconf="vim ~/.zshrc"
alias yabaiconf="vim ~/.config/yabai/yabairc"
alias skhdconf="vim ~/.config/skhd/skhdrc"
...
# bun completions
[ -s "/Users/albin.frick/.bun/_bun" ] && source "/Users/albin.frick/.bun/_bun"

# bun
export BUN_INSTALL="$HOME/.bun"
export PATH="$BUN_INSTALL/bin:$PATH"

# Listen to see which proccess is using a port
listening() {
    if [ $# -eq 0 ]; then
