return {
  "Al0den/notion.nvim",
  VeryLazy = true, --Should work when lazy loaded, not tested
  dependencies = {
  ...
  config = function()
    require("notion").setup({
      ...
      editor = "full", --light/medium/full, changes the amount of data displayed in editor
      viewOnEdit = {
